...
if (isset($_POST['submit'])) {
    ...
    $MoTa=$_POST['MoTa'];
    $GiaBan=$_POST['GiaBan'];
    if ($TenSanPham == ""){echo"Vui lòng nhập đủ tên!<br />";}
    if ($MoTa == ""){echo"Vui lòng nhập đủ Mô Tả!<br />";}
    if ($GiaBan == ""){echo"Vui lòng nhập giá bán!<br />";}
    if ($TenSanPham != "" && $MoTa!= ""&& $GiaBan!= "" ){
        $sql_fix = "UPDATE sanpham SET TenSanPham = '".$TenSanPham."', MoTa = '".$MoTa."',GiaBan = '".$GiaBan."' WHERE ID_SanPham= '".$ID_SanPham."' ";
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="TenSanPham" id="name" value="<?php echo $row['TenSanPham']?>">
                            </div>
                            <div class="form-group">
                                <label for="name">Mô tả</label>
                                <input class="form-control" type="text" name="MoTa" id="name" value="<?php echo $row['MoTa']?>">
                            </div>
                            <div class="form-group">
                                <label for="name">Giá Bán</label>
                                <input class="form-control" type="text" name="GiaBan" id="name" value="<?php echo $row['GiaBan']?>">
                            </div>
                            <div class="form-group">
                              <label for="formFile">Hình ảnh</label>
                              <img style="width: 276px;height: 247px;" src="../../image/product/<?php echo $row['Img'];?>">
                              <input class="form-control" type="file" name="image" value="<?php echo $row['Img'];?>">
                          </div>
